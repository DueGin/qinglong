...
LABEL maintainer="DueGin"

ENV QL_DIR=/ql \
  QL_BRANCH=copilot/support-multi-device-login \
  LANG=C.UTF-8 \
  SHELL=/bin/bash \
  PS1="\u@\h:\w \$ "
